...
// verify command both target tests/verdict.test.mjs directly and are
// unaffected by this file. (Same pattern as step 0's capsule.test.mjs shim.)
import './tests/verdict.test.mjs';
